...
namespace adap_samples_input
{
	class SamplesInput
	{
		public: 
			...
			void Filter_SV(std::queue<base::samples::RigidBodyState> &queue, double t, double n, base::samples::RigidBodyState &actual_RBS, base::samples::RigidBodyAcceleration &actual_RBA);
			...
			void Velocity (std::queue<base::samples::RigidBodyState> &queueOfRBS, int size, base::samples::RigidBodyState &actual_RBS, base::samples::RigidBodyState &last_RBS, base::samples::RigidBodyAcceleration &actual_RBA);
